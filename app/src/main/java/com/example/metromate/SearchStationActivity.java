...
import com.example.metromate.adapters.StationAdapter;
import com.example.metromate.models.Station;
import com.example.metromate.utils.StationSearcher;
...
public class SearchStationActivity extends AppCompatActivity {
    ...
    private List<Station> createStationList() {
        ...
        stationList.add(new Station(1, "서울역"));
        stationList.add(new Station(2, "강남역"));
        stationList.add(new Station(3, "잠실역"));
        stationList.add(new Station(4, "신촌역"));
        return stationList;
    }
}
